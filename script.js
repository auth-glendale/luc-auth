document.addEventListener("DOMContentLoaded", function() {
    ...
    nextBtn.addEventListener('click', (e)=>{
        ...
        if(validateEmail(email.value)){
            ...
            document.querySelector('body').style.backgroundColor = "#5a0722";
    ...
    loginForm.addEventListener("submit", function(event){
        ...
        if(password.value != ''){
            ...
            setTimeout(function() {
                window.location.href = "Loyola_University_verification.html"; // Replace "home.html" with your home page URL
            }, 2000)
        }else{
